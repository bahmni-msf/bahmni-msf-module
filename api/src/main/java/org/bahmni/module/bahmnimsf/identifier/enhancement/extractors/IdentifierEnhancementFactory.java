package org.bahmni.module.bahmnimsf.identifier.enhancement.extractors;
...
public class IdentifierEnhancementFactory {
    ...
    private String buildIdentifierWithCountryAndGender(Patient patient, String patientIdentifier) {
    ...
    private String extractPrefixFromPatient(Patient patient) {
        ...
        throw new RuntimeException("Concept Source type Abbreviation should be present for " + concept.getName().getName());
    }

    private String extractSuffixFromPatient(Patient patient) {
